class WorkerBoundaryEvent {
  ...
  factory WorkerBoundaryEvent.fromJson(Map<String, dynamic> json) {
    return WorkerBoundaryEvent(
      ...
      entryLat: json['entry_latitude'] != null ? (json['entry_latitude'] as num).toDouble() : null,
      entryLng: json['entry_longitude'] != null ? (json['entry_longitude'] as num).toDouble() : null,
